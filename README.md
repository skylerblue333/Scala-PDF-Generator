...
pdf generator in Scala.

## 🚀 Overview
This repository contains a professional implementation of **Scala PDF Generator**. It is designed with clean code principles and focuses on functionality and reliability.
